...
public class LocalStack extends Stack {
    ...
    public LocalStack(@Nullable final App scope, @Nullable final String id, @Nullable final StackProps props) {
        ...
        FargateService authService = createFargateService("AuthService", "auth-service",
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "Rm91cnR5X3R3b19jaGFyYWN0ZXJzX3NlY3JldF9mb3JfSFIyNTY="));
